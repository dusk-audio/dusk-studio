        ...
        if (track.nativeClapPath.isNotEmpty())
        {
            ...
            if (strip.isPrepared())
            {
                ...
                if (ok && ! blob.empty())
                {
                    ...
                    if (! ok) noteStateRejected ("track CLAP", t, blob.size());
                }
                resumeProcessing();
                if (! ok)
                {
        ...
        if (track.nativeLv2Path.isNotEmpty())
        {
            ...
            if (strip.isPrepared())
            {
                ...
                if (ok && ! blob.empty())
                {
                    ...
                    if (! ok) noteStateRejected ("track LV2", t, blob.size());
                }
                resumeProcessing();
                if (! ok)
                {
        ...
        if (track.nativeVst3Path.isNotEmpty())
        {
            ...
            if (strip.isPrepared())
            {
                ...
                if (ok && ! blob.empty())
                {
                    ...
                    if (! ok) noteStateRejected ("track VST3", t, blob.size());
                }
                resumeProcessing();
                if (! ok)
                {
        ...
        if (track.nativeAuIdentifier.isNotEmpty())
        {
            ...
            if (strip.isPrepared())
            {
                ...
                if (ok && ! blob.empty())
                {
                    ...
                    if (! ok) noteStateRejected ("track AU", t, blob.size());
                }
                resumeProcessing();
                if (! ok)
                {
