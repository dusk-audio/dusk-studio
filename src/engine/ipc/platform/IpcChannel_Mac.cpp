...
// macOS uses POSIX sockets + SCM_RIGHTS, identical to Linux. This file
// could share with IpcChannel_Linux.cpp via a *_Posix.cpp pattern, but
// keeping them split for now so the Linux file stays Linux-pure and the
// Mac file is the obvious slot for any future Mach-port migration.
