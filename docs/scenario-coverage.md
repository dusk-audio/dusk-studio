...
What the pre-tag audit checks by hand, and what runs it now.

| Item | Covered by |
|---|---|
| SMF header that over-counts its tracks (#502) | unit `midi_file_reader.cpp`; scenario `import.smf_irregular` (counted vendor chunk) |
