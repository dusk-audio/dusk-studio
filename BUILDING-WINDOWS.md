...
The fetch and detached checkout are also mandatory. The final command must
print `69f04318e3b7063e382c80ac1cde2388170e668b`. Dusk Studio consumes a
framework-free compressor core that is present at this workflow-pinned
revision but is not on the donor repository's current `main`. When that pin
moves, update every workflow and this guide together.
