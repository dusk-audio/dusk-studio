...
git -C plugins rev-parse HEAD | findstr /x /c:"00e3dc10f4a26931da823eca425dc9860d5e1737" >nul || (echo ERROR: donor checkout did not reach the pinned revision & exit /b 1)
```
