...
| 3   | Tape saturation       | Reel-to-reel model with a fixed, tuned 2× processing path independent of the global Effect Oversampling setting. Click the left status light to bypass/engage, click **TAPE** to open the editor, or right-click anywhere for the TAPE menu. |
...
- **Oversampling**: the tape model uses a fixed, tuned 2× processing path. It is independent of the engine-wide **Effect Oversampling** setting and has no per-stage toggle.
