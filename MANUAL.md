...
Open the **CC lane** below the velocity strip. Press **L** to cycle controllers (1, 7, 11, 64, 74; defaults to CC 1, Mod Wheel). Each CC event is a vertical bar; drag to adjust value, click empty grid to add a new event.
