...
The C++ suite declares 1103 Catch2 test cases across 207 test source files. Linux
...
tests/         # 1103 Catch2 test cases declared in C++ (session, recording, MIDI, IPC, DSP)
