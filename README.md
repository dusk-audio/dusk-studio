...
The C++ suite declares 1008 Catch2 test cases across 189 test source files. Linux
...
tests/         # 1008 Catch2 test cases declared in C++ (session, recording, MIDI, IPC, DSP)
