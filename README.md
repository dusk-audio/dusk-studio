...
The C++ suite declares 1115 Catch2 test cases across 206 test source files. Linux
...
tests/         # 1115 Catch2 test cases declared in C++ (session, recording, MIDI, IPC, DSP)
