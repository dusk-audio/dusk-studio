...
The C++ suite declares 1080 Catch2 test cases across 201 test source files. Linux
...
tests/         # 1080 Catch2 test cases declared in C++ (session, recording, MIDI, IPC, DSP)
