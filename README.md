...
The C++ suite declares 1068 Catch2 test cases across 199 test source files. Linux
...
tests/         # 1068 Catch2 test cases declared in C++ (session, recording, MIDI, IPC, DSP)
