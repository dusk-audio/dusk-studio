...
The C++ suite declares 1058 Catch2 test cases across 197 test source files. Linux
...
tests/         # 1058 Catch2 test cases declared in C++ (session, recording, MIDI, IPC, DSP)
