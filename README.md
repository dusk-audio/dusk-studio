...
The C++ suite declares 1063 Catch2 test cases across 198 test source files. Linux
...
tests/         # 1063 Catch2 test cases declared in C++ (session, recording, MIDI, IPC, DSP)
