...
The C++ suite declares 1087 Catch2 test cases across 204 test source files. Linux
...
tests/         # 1087 Catch2 test cases declared in C++ (session, recording, MIDI, IPC, DSP)
