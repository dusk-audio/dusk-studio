...
The C++ suite declares 1095 Catch2 test cases across 205 test source files. Linux
...
tests/         # 1095 Catch2 test cases declared in C++ (session, recording, MIDI, IPC, DSP)
