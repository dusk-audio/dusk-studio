...
The C++ suite declares 1141 Catch2 test cases across 208 test source files. Linux
...
tests/         # 1141 Catch2 test cases declared in C++ (session, recording, MIDI, IPC, DSP)
