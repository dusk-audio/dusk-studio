...
The C++ suite declares 1076 Catch2 test cases across 200 test source files. Linux
...
tests/         # 1076 Catch2 test cases declared in C++ (session, recording, MIDI, IPC, DSP)
