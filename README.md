...
The C++ suite declares 1078 Catch2 test cases across 201 test source files. Linux
...
tests/         # 1078 Catch2 test cases declared in C++ (session, recording, MIDI, IPC, DSP)
